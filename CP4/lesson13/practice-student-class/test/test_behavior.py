...
class SimpleTestCase(unittest.TestCase):
    ...
    def compare_student(
        ...
        if classes is not None:
            ...
            for c in classes:
                self.assertTrue(
                    c in student.classes, f"Expected classes to have key {c}"
                )
                assert_equals(self, classes[c], student.classes[c])

            self.assertEqual(
                student.classes.keys(),
                classes.keys(),
                f"Expected field to have the same classes as were originally provided",
            )
    ...
    def test_initializer_example(self):
        ...
        """
        self.compare_student(
            self.arlo,
            name="arlo",
            student_num=1231231,
            classes={"CSE163": 4, "MATH126": 5, "PHYS123": 5, "CSE373": 4},
        )
    ...
    def test_initializer_empty(self):
        ...
        """
        self.compare_student(
            self.empty, name="empty", student_num=10, classes={}
        )
    ...
    def test_get_classes(self):
        ...
        assert_equals(
            self,
            ["CSE163", "MATH126", "PHYS123", "CSE373"],
            self.arlo.get_classes(),
        )
