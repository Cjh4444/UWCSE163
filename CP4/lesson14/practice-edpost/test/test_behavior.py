...
class Test(unittest.TestCase):
    def test_fields(self):
        ...
        attrs = post.__dict__
        self.assertTrue(
            "_title" in attrs, "Should have a private field named title"
        )
        self.assertTrue(
            "_tag" in attrs, "Should have a private field named tag"
        )
        self.assertTrue(
            "_comments" in attrs, "Should have a private field named comments"
        )
